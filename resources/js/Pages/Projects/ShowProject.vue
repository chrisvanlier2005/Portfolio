...
<Layout>
    <div class="flex min-h-[50vh] relative gap-6  items-center justify-center">
        <div class="absolute left-0 top-12 w-fit h-fit  z-[99]">
        ...
        <!--            <GridCardSmall v-for="project in projects" :project="project"></GridCardSmall>-->
    ...
    <section class="relative min-h-screen flex flex-col z-[99] gap-3">
        ...
        <!--        <div class="pb-4">
                    <Link v-if="user" :href="'/projects/' + project.id + '/edit'">Edit</Link>
